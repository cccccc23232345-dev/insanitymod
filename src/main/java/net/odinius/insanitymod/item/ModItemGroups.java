...
public class ModItemGroups {
    public static final ItemGroup ALCOHOL_ITEM_GROUP = Registry.register(Registries.ITEM_GROUP, Identifier.of(InsanityMod.MOD_ID, "alcohol_items"),
            FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.WHISKEY)).displayName(Text.translatable("itemgroup.insanitymod.alcohol_items"))
